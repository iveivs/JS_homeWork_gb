// ключей несколько, т.к. ограничено число запросов на один ключ
// const ACCESS_KEY = 'ZfkCzoiCL-WeQxe4kCEp_iO2qAvzuq62JYpghzyUKAg'
// const ACCESS_KEY = '7msaJQrVXTXtNYxQJxqyA5wVkdmcbhT3-RXzltpxC8M'
...
const fetchPhoto = async () => {
    try {
        ...
        if (response.ok) {
            ...
            // отображение лайка и увеличение/уменьшение лайков
...
btn.addEventListener('click', () => {
    fetchPhoto()
    const temp = document.querySelectorAll('.history-item')
    temp.forEach(el => {
        el.remove()
    })
...
// рендер предыдущих фотографий(история)
